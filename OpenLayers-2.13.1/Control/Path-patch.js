/* Copyright 2013-2014 by Xavier Mamano, http://github.com/jorix/OL-Ragbag
...
(function() {
    ...
    if (OpenLayers.Handler.Polygon) {
        OpenLayers.Handler.Polygon = addhandleKeypress(OpenLayers.Handler.Polygon);
    }
